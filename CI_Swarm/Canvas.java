...
//          	else 		  g2d.setColor(Color.BLACK);
        ...
        int foodX = (int)(Simulation.foodPos[0] / pix);
        int foodY = (int)(Simulation.foodPos[1] / pix);
        g2d.fillOval(foodX - 5, foodY - 5, 10, 10);

        //Paint obstacles
        g2d.setColor(Color.LIGHT_GRAY);
        for (int i = 0; i < Simulation.obstacles.length; i++) {
            int obsX = (int)(Simulation.obstacles[i][0] / pix);
            int obsY = (int)(Simulation.obstacles[i][1] / pix);
            int obsR = (int)(Simulation.obstacles[i][2] / pix);

            // fillOval braucht die obere linke Ecke, daher ziehen wir den Radius von X und Y ab
            g2d.fillOval(obsX - obsR, obsY - obsR, 2 * obsR, 2 * obsR);
        }
    }
}
